  ...
  "node_modules/jwa/index.js"(exports, module2) {
    ...
    function createKeyVerifier(bits) {
      return function verify(thing, signature, publicKey) {
        ...
        var verifier2 = crypto.createVerify("RSA-SHA" + bits);
        verifier2.update(thing);
        return verifier2.verify(publicKey, signature, "base64");
      };
    }
...
// src/functions/authorization/handler.ts
__export(exports, {
  verifier: () => verifier
});
var jwt = require_jsonwebtoken();
var verifier = async (event) => {
  let bearerheader = event("authorizationtoken");
